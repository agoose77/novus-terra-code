...
class MessageBox(bgui.Widget):
	...
	def display_dialogue(self, text):
		...
		# resize scrollbar
		self.scrollbar.slider_size = (self.scrollbar.slider_size / ((i) * self.char_height + (i-1) * MessageBox.LINE_PADDING)) * self.scrollbar.size[1]
